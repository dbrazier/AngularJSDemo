...
describe('account', function () {
    ...
    it('should fail to login with bad password', function () {
        ...
        expect(element(by.css('.alert-danger')).getText()).toMatch(/Failed to sign in! Please check your credentials and try again./);
    ...
    it('should login successfully with admin account', function () {
        ...
        expect(element(by.css('.alert-success')).getText()).toMatch(/You are logged in as user/);
    ...
    it('should be able to update settings', function () {
        ...
        expect(element(by.css('h2')).getText()).toMatch(/User settings for/);
    ...
    it('should be able to update password', function () {
        ...
        expect(element.all(by.css('h2')).first().getText()).toMatch(/Password for/);
