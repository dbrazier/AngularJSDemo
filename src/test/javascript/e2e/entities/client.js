...
describe('Client e2e test', function () {
    ...
    it('should load Clients', function () {
        entityMenu.click();
        element(by.css('[ui-sref="client"]')).click().then(function() {
    ...
    it('should load create Client dialog', function () {
        element(by.css('[ui-sref="client.new"]')).click().then(function() {
            expect(element(by.css('h4.modal-title')).getAttribute("translate")).toMatch(/mosaicApp.client.home.createOrEditLabel/);
